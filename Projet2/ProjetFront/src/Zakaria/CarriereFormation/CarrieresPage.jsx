...
const CarrieresPage = () => {
  ...
  const findDepartmentName = useCallback((deptId) => {
    if (!deptId) return "";
    const dept = findDeptById(departements, deptId);
    return dept?.nom ?? "";
  }, [departements, findDeptById]);
  ...
  useEffect(() => {
    ...
    const dept = findDeptById(departements, selectedDepartementId);
    ...
    setSelectedEmployee(null);
  }, [selectedDepartementId, includeSubDepartments, departements, allEmployees, collectDeptIds, findDeptById]);
  ...
  return (
    <ThemeProvider theme={createTheme()}>
      <Box sx={{ ...dynamicStyles, minHeight: "100vh", backgroundColor: "#ffffff" }}>
        ...
        >
          <div className="departement_home1 career-scroll-layout" style={{ gap: "8px", padding: "8px" }}>
            {/* 1. Department tree */}
            ...
            <div className="employee-panel" style={{ minWidth: "220px", maxWidth: "280px", display: "flex", flexDirection: "column" }}>
              <input
                type="text"
