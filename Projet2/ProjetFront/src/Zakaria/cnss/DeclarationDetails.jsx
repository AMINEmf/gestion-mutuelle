...
function DeclarationDetails({ declaration, onClose }) {
  ...
  const fetchDeclarationDetails = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.get(`/api/cnss/declarations/${declaration.id}`);
          ...
          <div style={{ position: "relative", height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ padding: "25px 30px", flex: 1, overflowY: 'auto' }}>
              ...
              <div className="section-header" style={{ marginBottom: "25px" }}>
                <SectionTitle iconComponent={FileText} text="Détails Déclaration CNSS" />
              </div>
              ...
              <div className="mb-4">
                {(() => {
                  const statusColors = {
                    ...
                    EN_ATTENTE: themeColors.warning,
                  };
                  const color = statusColors[summary.statut] || themeColors.textSecondary;
                  return (
                    <span
                      style={{
              ...
              <div className="section-header" style={{ marginTop: "30px", marginBottom: "20px" }}>
                <SectionTitle iconComponent={Users} text="Employés déclarés" />
              </div>
