...
const Navigation = () => {
  ...
  const [isCarriereFormationOpen, setIsCarriereFormationOpen] = useState(false);
  ...
  const handleCarriereFormationClick = () => {
    setIsCarriereFormationOpen(!isCarriereFormationOpen);
  };
