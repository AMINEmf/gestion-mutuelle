...
# Prompt pour réaliser les diagrammes UML — Module Gestion Mutuelle & Carrières/Formations

---

## Contexte

Réalise les diagrammes UML suivants pour une application web RH (Laravel + React) composée de deux modules principaux : **Gestion Mutuelle** . Il y a un seul acteur : **RH** (Responsable Ressources Humaines).
